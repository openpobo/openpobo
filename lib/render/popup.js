...
export function renderPopup(props = {}){
	...
	// ====================== POPUP IMAGE ======================
	const popupImage = post.slug
		? ogImage(sanitizeSlug(post.slug))
		: DEFAULT_POPUP.image;
...
<a href="${loginUrl}" target="_blank" rel="nofollow noreferrer" class="login">
LOGIN
</a>

<a href="${registerUrl}" target="_blank" rel="nofollow noreferrer" class="register">
DAFTAR
</a>
...
<span style="color:#6A994E;font-weight:600;text-shadow:0 0 5px rgba(212,175,55,.5);">
...
<style>
	...
	.clk-btn-sgp::before {
		...
		width: calc(100% - 30px);
		height: 2px;
		background: linear-gradient(90deg, transparent, 6A994E, 6A994E, 6A994E, transparent);
		opacity: 0.4;
		filter: blur(1px);
	}
	...
	.clk-btn-sgp a::after {
		...
		right: -2px;
		bottom: -2px;
		background: linear-gradient(45deg, 48CAE4, 6A994E, 6A994E, 6A994E, 48CAE4);
		border-radius: 16px;
		z-index: -1;
		opacity: 0;
