            ...
            <script>
                (function () {
                    ...
                    faqButtons.forEach((btn, idx) => {
                        ...
                        const qId = `LAPAKGACOR LOGIN-faq-q-${idx}`;
                        const pId = `LAPAKGACOR LOGIN-faq-p-${idx}`;
                        btn.id = qId;
                        panel.id = pId;
            ...
            <div class="footer-category__list-wrap">
              <ul class="footer-category__list" role="list">
                <li class="footer-category__item" role="listitem">
                  <a class="footer-category__link" href="https://aribaconsultinggroup.com/clients">
                    LAPAKGACOR
                  </a>
                </li>
                <li class="footer-category__item" role="listitem">
      ...
      <div class="footer-bottom">
        <div class="footer-copyright-wrap">
          ...
          <div class="footer-language">
            <a class="footer-language__anchor" href="https://aribaconsultinggroup.com/clients">
    ...
    <div class="layer-popup" id="fold-alert-popup" role="dialog" style="display:block" tabindex="0">
     <div class="layer-popup__inner">
      ...
      <div class="fold-alert-popup__cta">
       <!--/* P6의 cta 적용 방식에 따라 마크업 변경 */ -->
       <a class="cta cta--outlined cta--black" href="https://aribaconsultinggroup.com/clients" title="Tutup">
        Tutup
       </a>
      </div>
      <button class="layer-popup__close" type="button">
     ...
     <div class="layer-popup__inner">
      <div class="layer-popup__contents">
       ...
       <div class="hubble-care-popup__alert-button">
        <a class="cta cta--contained cta--emphasis" href="https://aribaconsultinggroup.com/clients" title="Best&auml;tigen">
         Best&auml;tigen
        </a>
       </div>
      </div>
     ...
     <div class="layer-popup__inner">
      ...
      <div class="wishlist-popup__cta-wrap">
       <div class="wishlist-popup__cta">
        <a aria-label="Link Title" class="cta cta--outlined cta--black" href="https://aribaconsultinggroup.com/clients" role="button">
        </a>
       </div>
       <div class="wishlist-popup__cta">
        <a class="cta cta--contained cta--emphasis" href="https://aribaconsultinggroup.com/clients" role="button">
        </a>
       </div>
      </div>
       ...
       <div class="extended-warranty-popup__button">
        ...
        <div class="extended-warranty-popup__button-inner">
         <div class="extended-warranty-popup__button-item">
          <a an-ac="pd buying tool" an-ca="option click" an-la="samsung warranty:close" an-tr="header(pim)_service option selector-product detail-popup-button" class="cta cta--outlined cta--black" href="https://aribaconsultinggroup.com/clients" role="button">
           Tutup
          </a>
         </div>
         <div class="extended-warranty-popup__button-item">
          <a an-ac="pd buying tool" an-ca="option click" an-la="samsung warranty:confirm" an-tr="header(pim)_service option selector-product detail-popup-button" class="cta cta--contained cta--emphasis cta--disabled" href="https://aribaconsultinggroup.com/clients" role="button">
           Yakin
          </a>
         </div>
        </div>
     ...
     <div class="layer-popup__inner">
      <div class="layer-popup__contents">
       ...
       <div class="extended-warranty-popup__alert-button">
        <a class="cta cta--contained cta--emphasis" href="https://aribaconsultinggroup.com/clients">
         Best&auml;tigen
        </a>
       </div>
      </div>
    ...
    <div class="layer-popup" id="extended-warranty-alert2">
     <div class="layer-popup__inner">
      <div class="layer-popup__contents">
       Ich habe das Informationsblatt zur Versicherung heruntergeladen und sorgf&auml;ltig durchgelesen.
       <div class="extended-warranty-popup__alert-button">
        <a class="cta cta--contained cta--emphasis" href="https://aribaconsultinggroup.com/clients" title="">
         Best&auml;tigen
        </a>
       </div>
      </div>
       ...
       <div class="extended-warranty-popup-vd__button">
        <div class="extended-warranty-popup-vd__button-inner">
         <div class="extended-warranty-popup-vd__button-item">
          <a class="cta cta--outlined cta--black" href="https://aribaconsultinggroup.com/clients" role="button">
           Tutup
          </a>
         </div>
         <div class="extended-warranty-popup-vd__button-item">
          <a class="cta cta--contained cta--emphasis cta--disabled" href="https://aribaconsultinggroup.com/clients" role="button">
           Yakin
          </a>
         </div>
        </div>
